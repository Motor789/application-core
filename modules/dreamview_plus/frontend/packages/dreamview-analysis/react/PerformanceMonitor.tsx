    ...
    return ReactDOM.createPortal(
        <Draggable handle=".handle">
            <Resizable
                ...
                maxHeight={1800}
                style={{
                    position: 'fixed', bottom: 4, right: 4, backgroundColor: 'transparent', padding: '10px', zIndex: 1000
                }}
            >
                <div style={{
                    position: 'relative', width: '100%', height: '100%', backgroundColor: 'rgba(15, 15, 20, .6)', padding: '10px',
                    borderRadius: '6px',
                    boxShadow: '0 2px 6px rgba(26, 29, 36, .5)', zIndex: 1000,
                    backdropFilter: 'blur(10px)',
                }}>
                    <div
                        style={{cursor: 'move', display: 'flex', justifyContent: 'space-between', padding: '10px', position: 'absolute', width: '100%', top: 0, left: 0, zIndex: 1000, backgroundColor: 'rgba(26, 29, 36, 1)', borderRadius: '6px'}}
                        className="handle">
                    ...
                    <div style={{
                        ...
                        <ReactJson src={data} theme="monokai" collapsed={2} enableClipboard={true}
